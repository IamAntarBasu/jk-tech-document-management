...
describe("IngestionController", () => {
  ...
  it("should call addIngestion", async () => {
    ...
    const CreateIngestionValidation = { documentId: 1 };

    const result = await controller.create(CreateIngestionValidation);

    expect(service.addIngestion).toHaveBeenCalledWith(CreateIngestionValidation);
